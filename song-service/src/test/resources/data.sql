...
insert into songs (id, released, artist, label, title) values(7, 1993, '4 Non Blondes', 'Interscope', 'What’s Up?');
...
insert into songlists values(1, false, 'Maximes Public Playlist', 'maxime');
